...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/home.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-277f7b26", Component.options)
  } else {
    hotAPI.reload("data-v-277f7b26", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/countUp.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-65d17d18", Component.options)
  } else {
    hotAPI.reload("data-v-65d17d18", Component.options)
  }
})()}
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            setTimeout(function () {
                ...
                _this.unit = res.unit;
                var demo = {};
                _this.demo = demo = new _countUp2.default(_this.idName, _this.startVal, endVal, _this.decimals, _this.duration, _this.options);
                if (!demo.error) {
                    demo.start();
                }
            }, _this.delay);
...
var echarts = __webpack_require__(143);
...
var _countUp = __webpack_require__(713);
...
var _echarts = __webpack_require__(143);

var _echarts2 = _interopRequireDefault(_echarts);

var _getGeographyValue = __webpack_require__(750);

var _getGeographyValue2 = _interopRequireDefault(_getGeographyValue);
...
exports.default = {
    ...
    mounted: function mounted() {
        var convertData = function convertData(data) {
            ...
            var len = data.length;
            for (var i = 0; i < len; i++) {
                var geoCoord = _getGeographyValue2.default[data[i].name];
                if (geoCoord) {
                    res.push({
                        name: data[i].name,
        ...
        var map = _echarts2.default.init(document.getElementById('home_page_map'));
        var chinaJson = __webpack_require__(836);
        _echarts2.default.registerMap('china', chinaJson);
        map.setOption({
            backgroundColor: '#FFF',
            geo: {
                map: 'china',
...
exports.default = {
    name: 'userFlow',
    mounted: function mounted() {
        var userFlow = _echarts2.default.init(document.getElementById('user_flow'));
...
exports.default = {
    ...
    mounted: function mounted() {
        this.$nextTick(function () {
            var visiteVolume = echarts.init(document.getElementById('visite_volume_con'));
            var xAxisData = [];
            var data1 = [];
            var data2 = [];
            for (var i = 0; i < 20; i++) {
            ...
            var option = {
                ...
                series: [{
                    name: '访问量',
                    type: 'bar',
                    data: [{ value: 453682, name: 'Mon', itemStyle: { normal: { color: '#2d8cf0' } } }, { value: 879545, name: 'Tues', itemStyle: { normal: { color: '#2d8cf0' } } }, { value: 2354678, name: 'Wed', itemStyle: { normal: { color: '#2d8cf0' } } }, { value: 1598403, name: 'Thur', itemStyle: { normal: { color: '#2d8cf0' } } }, { value: 543250, name: 'Fri', itemStyle: { normal: { color: '#2d8cf0' } } }, { value: 1305923, name: 'Sat', itemStyle: { normal: { color: '#2d8cf0' } } }, { value: 1103456, name: 'Sun', itemStyle: { normal: { color: '#2d8cf0' } } }]
                }]
            };
...
var _getCityValue = __webpack_require__(749);

var _getCityValue2 = _interopRequireDefault(_getCityValue);

var _map = __webpack_require__(794);

var _map2 = _interopRequireDefault(_map);

var _dataSourcePie = __webpack_require__(792);

var _dataSourcePie2 = _interopRequireDefault(_dataSourcePie);

var _visiteVolume = __webpack_require__(799);

var _visiteVolume2 = _interopRequireDefault(_visiteVolume);

var _serviceRequests = __webpack_require__(796);

var _serviceRequests2 = _interopRequireDefault(_serviceRequests);

var _userFlow = __webpack_require__(798);

var _userFlow2 = _interopRequireDefault(_userFlow);

var _countUp = __webpack_require__(713);

var _countUp2 = _interopRequireDefault(_countUp);

var _inforCard = __webpack_require__(793);

var _inforCard2 = _interopRequireDefault(_inforCard);

var _mapDataTable = __webpack_require__(795);

var _mapDataTable2 = _interopRequireDefault(_mapDataTable);

var _toDoListItem = __webpack_require__(797);
...
exports.default = {
    components: {
        homeMap: _map2.default,
        dataSourcePie: _dataSourcePie2.default,
        visiteVolume: _visiteVolume2.default,
        serviceRequests: _serviceRequests2.default,
        userFlow: _userFlow2.default,
        countUp: _countUp2.default,
        inforCard: _inforCard2.default,
        mapDataTable: _mapDataTable2.default,
        toDoListItem: _toDoListItem2.default
    },
    data: function data() {
        return {
            toDoList: [{
            ...
            cityData: _getCityValue2.default,
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/dataSourcePie.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] dataSourcePie.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-460fc8f5", Component.options)
  } else {
    hotAPI.reload("data-v-460fc8f5", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/inforCard.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-368b057c", Component.options)
  } else {
    hotAPI.reload("data-v-368b057c", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/map.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4c7b006a", Component.options)
  } else {
    hotAPI.reload("data-v-4c7b006a", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/mapDataTable.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] mapDataTable.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2ccdd52a", Component.options)
  } else {
    hotAPI.reload("data-v-2ccdd52a", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/serviceRequests.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] serviceRequests.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b92f927", Component.options)
  } else {
    hotAPI.reload("data-v-0b92f927", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/toDoListItem.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] toDoListItem.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1d9280b9", Component.options)
  } else {
    hotAPI.reload("data-v-1d9280b9", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/userFlow.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] userFlow.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5751a4fb", Component.options)
  } else {
    hotAPI.reload("data-v-5751a4fb", Component.options)
  }
})()}
...
Component.options.__file = "/Users/august/Open/iview-admin/src/views/home/components/visiteVolume.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] visiteVolume.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6aa41316", Component.options)
  } else {
    hotAPI.reload("data-v-6aa41316", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-0b92f927", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-1d9280b9", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Admin")]), _vm._v(" "), _c('p', [_vm._v("super admin")])])])], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "line-gray"
  }), _vm._v(" "), _c('Row', {
    ...
    staticClass: "notwrap"
  }, [_vm._v("上次登录时间:")])]), _vm._v(" "), _c('Col', {
    staticClass: "padding-left-8",
    attrs: {
      "span": "16"
    }
  }, [_vm._v("2017.09.12-13:32:20")])], 1), _vm._v(" "), _c('Row', {
    staticClass: "margin-top-8"
  }, [_c('Col', {
    attrs: {
      "span": "8"
    ...
    staticClass: "notwrap"
  }, [_vm._v("上次登录地点:")])]), _vm._v(" "), _c('Col', {
    staticClass: "padding-left-8",
    attrs: {
      "span": "16"
    }
  }, [_vm._v("北京")])], 1)], 1)], 1), _vm._v(" "), _c('Row', {
    ...
    on: {
      "on-ok": _vm.addNew,
      "on-cancel": _vm.cancelAdd
    },
    model: {
      value: (_vm.showAddNewTodo),
      callback: function($$v) {
        _vm.showAddNewTodo = $$v
      },
      expression: "showAddNewTodo"
    }
  }, [_c('Row', {
    attrs: {
      "type": "flex",
    ...
    model: {
      value: (_vm.newToDoItemValue),
      callback: function($$v) {
        _vm.newToDoItemValue = $$v
      },
      expression: "newToDoItemValue"
    }
  })], 1), _vm._v(" "), _c('Row', {
    attrs: {
      "slot": "footer"
    ...
    staticClass: "data-source-row"
  }, [_c('visite-volume')], 1)])], 1), _vm._v(" "), _c('Col', {
    ...
    staticClass: "data-source-row"
  }, [_c('data-source-pie')], 1)])], 1), _vm._v(" "), _c('Col', {
    staticClass: "padding-left-10",
    attrs: {
      "span": "8"
    }
    ...
    staticClass: "data-source-row"
  }, [_c('user-flow')], 1)])], 1)], 1), _vm._v(" "), _c('Row', {
    staticClass: "margin-top-10"
  }, [_c('Card', [_c('p', {
    staticClass: "card-title",
    attrs: {
    ...
    staticClass: "line-chart-con"
  }, [_c('service-requests')], 1)])], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-277f7b26", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-2ccdd52a", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-368b057c", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-460fc8f5", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-4c7b006a", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-5751a4fb", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-65d17d18", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-6aa41316", module.exports)
  }
}
